class NewbooksBookModel {
  String title, author, price, image, description;
  int color;

  NewbooksBookModel(this.title, this.author, this.price, this.image, this.color,
      this.description);
}

List<NewbooksBookModel> newbooks = newBookData
    .map((item) => NewbooksBookModel(item['title'], item['author'],
